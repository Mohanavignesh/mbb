...
def main():
    st.markdown("<h1 style='text-align: center;'>MobileBERT Extractive Summary✏️</h1>", unsafe_allow_html=True)
    ...
    if input_type == "Raw Text":
        ...
        url = st.text_input("", "https://edition.cnn.com/2021/04/06/us/derek-chauvin-trial-george-floyd-day-7/index.html")
